...
import ReadFilePDF from '../TabContent/ReadFilePDF/ReadFilePDF';

type useReadFilePDFProps = {
    handleClickRadarChart: any;
    mediumLine: any;
};

const useReadFilePDF = ({ handleClickRadarChart, mediumLine }: useReadFilePDFProps): SearchForSupplierTabContainer => {
    ...
    return {
        ...
        controlBar: (
            <SearchMenuBar>
                <SubMenuQCD mediumLine={mediumLine} handleClickRadarChart={handleClickRadarChart} />
            </SearchMenuBar>
        ),
        content: <ReadFilePDF />,
    };
