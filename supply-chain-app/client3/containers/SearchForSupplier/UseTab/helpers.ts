...
function convertDataTableSearch(searchResult) {
...
const calculateMediumLine = (dataTableSearch) => {
...
export { convertDataTableSearch, convertDataCompareChart, calculateMediumLine, ComparisonType };
