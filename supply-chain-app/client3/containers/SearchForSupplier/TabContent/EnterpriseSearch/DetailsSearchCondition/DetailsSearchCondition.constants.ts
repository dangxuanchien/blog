...
import { columnStyleHeader, columStyle } from './DetailSearchCondition.style';
...
export const getColumnsCandidate = (
    ...
    renderCategoryGroupName: (value: unknown, row: any) => ReactNode,
    renderCategoryName: (value: unknown, row: any) => ReactNode
): ColDef<any>[] => {
    return [
        {
            title: '',
