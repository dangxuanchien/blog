...
// react-pdf-viewer/ => build production => iframe

// window.URL.createObjectURL => cached : url broswer => memory leaks =>
const ReadFilePDF = () => {
    ...
    return (
        <Box className={style.viewPage}>
            <Typography className={style.companyName}>
                {t('detailSupplier.corporateTrustEvaluationDetails')} :{currentCompany.companyName}
            </Typography>
