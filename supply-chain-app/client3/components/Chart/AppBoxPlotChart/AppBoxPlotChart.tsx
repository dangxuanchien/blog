...
import { useAppBoxPlotChartStyles } from './AppBoxPlotChart.style';
...
const AppBoxPlotChart: React.FC<AppBoxPlotChartProps> = (props) => {
    const { width = 200, height = 28, checkpoint, showMedium = false, data, errorOverlay } = props;
    const classes = useAppBoxPlotChartStyles();
...
export default AppBoxPlotChart;
